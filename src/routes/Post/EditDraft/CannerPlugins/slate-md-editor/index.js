...
import { CodeBlockPlugin } from "../slate-icon-codeblock";
import { HrPlugin } from "@canner/slate-icon-hr";
import { LinkPlugin } from "../slate-icon-link";
import { ImagePlugin } from "../slate-icon-image";
import {
  HeaderOnePlugin,
  HeaderTwoPlugin,
  HeaderThreePlugin,
...
import HelpMenu from "../slate-editor-help";
...
export default (opt = {}) => {
  ...
  return class MdEditor extends React.Component {
    constructor(props) {
      super(props);
